...
export function Table({ tickets, description, theme }: Props) {
  const themes:{[key: string]: string;} = {
    hearts: '/img/seamless-pattern-with-hearts-simple-repeating-texture-for-background-wrapping-paper-wedding-and-valentine-day-greeting-and-invitation-cards-design-and-decoration-vector.jpg',
    geometric: '/img/geometric-low-poly-graphic-repeat-pattern-background-free-vector.jpg',
  ...
  return (
    <div className="bg-white">
      <button onClick={screenshot} className="text-zinc-800 pl-8 p-4">Screenshot</button>
